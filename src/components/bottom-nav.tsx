...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 z-40 w-full border-t border-brand-line bg-[rgba(255,255,255,0.84)] pb-safe backdrop-blur-xl dark:bg-[rgba(19,26,46,0.84)] md:hidden">
